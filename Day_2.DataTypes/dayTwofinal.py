...
print("The bill is {} and the tip percent is {} % so,the total bill is {} and we share it with {} and each pays {} dollar ".format(total_amount,tip_waiter,sum_total,number_of_people,total_bill))
